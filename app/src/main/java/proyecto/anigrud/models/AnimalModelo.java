...
public class AnimalModelo {
    ...
    public ArrayList<Animal> getAllanimal(){
        ...
        String imagen = "iVBORw0KGgoAAAANSUhEUgAAAGAAAABgCAYAAADimHc4AAAABHNCSV" +
        ...
        Animal a1 = new Animal(1,"gato",imagen,"felino");
        Animal a2 = new Animal(2,"perro",imagen,"canido");
        Animal a3 = new Animal(3,"elefante",imagen,"elefantido");
        list.add(a1);
        list.add(a2);
        list.add(a3);
